#!/usr/bin/env node
/**
 * Vendored from https://github.com/cursor/plugin-template/blob/main/scripts/validate-template.mjs
 * Copied into rinkata-plugin on marketplace-repo export. Do not diverge.
 */
